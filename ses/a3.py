...
def speech_to_text():
    ...
    try:
        ...
        wrapper = textwrap.TextWrapper(width=80)  # 80 karakter genişliğinde satırlara böler
...
extra_frame = tk.Frame(main_frame, bg="#ffffff", bd=2, relief="solid")
extra_frame.grid(row=0, column=2, padx=10, pady=10, sticky="nsew")

extra_label = tk.Label(extra_frame, text="Ek İşlemler", font=("Arial", 16, "bold"), bg="#ffffff")
extra_label.pack(pady=10)

plot_button = tk.Button(extra_frame, text="Dalga Formu ve Spektrogram Göster", command=display_waveform_and_spectrogram, bg="#519aba", fg="white", font=("Arial", 12), relief="flat")
plot_button.pack(pady=10)

emotion_button = tk.Button(extra_frame, text="Ses Analizi (Duygu)", command=analyze_emotion, bg="#519aba", fg="white", font=("Arial", 12), relief="flat")
emotion_button.pack(pady=5, padx=2)

speech_to_text_button = tk.Button(extra_frame, text="Konuşmayı Metne Çevir ve Kelime Say", command=speech_to_text, bg="#519aba", fg="white", font=("Arial", 12), relief="flat")
speech_to_text_button.pack(pady=5, fill=tk.X)

topic_analysis_button = tk.Button(extra_frame, text="Konuşulan Konuyu Analiz Et", command=analyze_topic, bg="#519aba", fg="white", font=("Arial", 12), relief="flat")
topic_analysis_button.pack(pady=5, fill=tk.X)

realtime_button = tk.Button(extra_frame, text="Anlık Ses Tanıma", command=recognize_from_recording, bg="#519aba", fg="white", font=("Arial", 12), relief="flat")
