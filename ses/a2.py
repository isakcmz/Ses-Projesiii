...
# Başlık
header = tk.Label(app, text="Ses ve Sahip Kaydı", font=("Arial", 24, "bold"), bg="#4CAF50", fg="white", pady=10)
...
# Sol çerçeve
left_frame = tk.Frame(main_frame, bg="#ffffff", bd=2, relief="solid")
left_frame.grid(row=0, column=0, padx=10, pady=10, sticky="nsew")

left_label = tk.Label(left_frame, text="Bilgi Girişi", font=("Arial", 16, "bold"), bg="#ffffff")
left_label.pack(pady=10)

# Giriş alanları
name_label = tk.Label(left_frame, text="Sahibin Adı:", font=("Arial", 12), bg="#ffffff")
name_label.pack(pady=5, anchor="w")
name_entry = tk.Entry(left_frame, width=40, font=("Arial", 12))
name_entry.pack(pady=5)

file_label = tk.Label(left_frame, text="Ses Dosyası:", font=("Arial", 12), bg="#ffffff")
...
file_button = tk.Button(file_frame, text="Seç", command=select_file, bg="#4CAF50", fg="white", font=("Arial", 12), relief="flat")
...
# Çöp kutusu butonuna ekle
clear_button = tk.Button(file_frame, image=trash_icon, command=clear_fields, bg="#ffffff", relief="flat")
clear_button.pack(side=tk.LEFT, padx=5)

# Kaydet butonu
save_button = tk.Button(left_frame, text="Kaydet", command=save_data, bg="#4CAF50", fg="white", font=("Arial", 12), relief="flat")
save_button.pack(pady=10, fill=tk.X)

# Listeleme butonu
list_button = tk.Button(left_frame, text="Listele", command=list_data, bg="#2196F3", fg="white", font=("Arial", 12), relief="flat")
list_button.pack(pady=10, fill=tk.X)

# Sağ çerçeve
right_frame = tk.Frame(main_frame, bg="#ffffff", bd=2, relief="solid")
right_frame.grid(row=0, column=1, padx=10, pady=10, sticky="nsew")

right_label = tk.Label(right_frame, text="İşlemler", font=("Arial", 16, "bold"), bg="#ffffff")
right_label.pack(pady=10)

# İşlem butonları
record_button = tk.Button(right_frame, text="Kayda Başla", command=start_recording, bg="#FF5722", fg="white", font=("Arial", 12), relief="flat")
record_button.pack(pady=5, fill=tk.X)

stop_button = tk.Button(right_frame, text="Kaydı Durdur", command=stop_recording, bg="#FF5722", fg="white", font=("Arial", 12), relief="flat")
stop_button.pack(pady=5, fill=tk.X)

plot_button = tk.Button(right_frame, text="Dalga Formu ve Spektrogram Göster", command=display_waveform_and_spectrogram, bg="#3F51B5", fg="white", font=("Arial", 12), relief="flat")
plot_button.pack(pady=10, fill=tk.X)

play_button = tk.Button(right_frame, text="Ses Dosyasını Oynat", command=play_audio, bg="#8BC34A", fg="white", font=("Arial", 12), relief="flat")
play_button.pack(pady=5, fill=tk.X)

stop_play_button = tk.Button(right_frame, text="Ses Oynatmayı Durdur", command=stop_audio, bg="#8BC34A", fg="white", font=("Arial", 12), relief="flat")
stop_play_button.pack(pady=5, fill=tk.X)

emotion_button = tk.Button(right_frame, text="Ses Analizi (Duygu)", command=analyze_emotion, bg="#9C27B0", fg="white", font=("Arial", 12), relief="flat")
emotion_button.pack(pady=5, fill=tk.X)

speech_to_text_button = tk.Button(right_frame, text="Konuşmayı Metne Çevir ve Kelime Say", command=speech_to_text, bg="#795548", fg="white", font=("Arial", 12), relief="flat")
speech_to_text_button.pack(pady=5, fill=tk.X)

topic_analysis_button = tk.Button(right_frame, text="Konuşulan Konuyu Analiz Et", command=analyze_topic, bg="#FF9800", fg="white", font=("Arial", 12), relief="flat")
topic_analysis_button.pack(pady=5, fill=tk.X)

realtime_button = tk.Button(right_frame, text="Anlık Ses Tanıma", command=recognize_from_recording, bg="#607D8B", fg="white", font=("Arial", 12), relief="flat")
realtime_button.pack(pady=5, fill=tk.X)
